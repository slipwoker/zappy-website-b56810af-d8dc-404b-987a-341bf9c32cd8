document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Optional: show success state if form is AJAX-handled
      const successMessage = contactForm.getAttribute('data-success-message');
      if (successMessage && contactForm.getAttribute('data-ajax') === 'true') {
        e.preventDefault();
        contactForm.classList.add(SUCCESS_CLASS);
        const successEl = document.createElement('p');
        successEl.className = 'form__success-message';
  ...
  if (animatedElements.length > 0) {
    ...
    if (!document.getElementById('scroll-animation-styles')) {
      ...
      style.textContent = [
        ...
        '}',
        '.animate-on-scroll.is-visible, [data-animate].is-visible {',
        '  opacity: 1;',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית נאמן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b56810af-d8dc-404b-987a-341bf9c32cd8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b56810af-d8dc-404b-987a-341bf9c32cd8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b56810af-d8dc-404b-987a-341bf9c32cd8';
